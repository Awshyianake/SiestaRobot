    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Futanoki Chatbot Disabled By {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Futanoki Chatbot Enabled By {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
CHATBOTK_HANDLER = CommandHandler("chatbot", futanoki )
ADD_CHAT_HANDLER = CallbackQueryHandler(anokiadd, pattern=r"add_chat" )
RM_CHAT_HANDLER = CallbackQueryHandler(anokirm, pattern=r"rm_chat" )
