...
DEFAULT_WELCOME_MESSAGES = [
    "Ngapain gabung {mention}, Sange ya 😏",  # Discord welcome messages copied
    "Eh kak {mention}, Tau gak perbedaan kamu dan kucing?",
    "Halo {mention}, Apa kabar kak?",
    "Woii {mention}, ngapain kemari? Out lu ngentod!",
    "Wah is you beautiful {mention} kek pler ☺",
    "Halo kak {mention}, Mutualan tytyd yu 🥵",
    "Si kontol {mention} telah bergabung. Mari kita entod ☺",
    "Dua tiga tutup botol, Muka {mention} kek kontol",
    "Halo kak {mention}, Aku Niskala, aku ramah dan baik hati kok 😊",
    "Halo {mention}, saya akan bawa kamu, ke neraka jahanam, tak sobek² mulutmu.",
    "Mas {mention} Aku hamil mas, Tanggung jawab loh 😔",
    "Selamat bergabung kak {mention}, Anda sopan? Saya curiga 😏",
    "Bisa apa lu {mention} ke sini tod ? Mending mati aja",
    "Selamat bergabung kak {mention}",
    "Pasti lu {mention} ke sini gara gara di culik sama si ngentod",
    "Emang keren lu masuk sini {mention}?",
    "Asem {mention} juga malah ikutan kemari",
    "Gay lu ya {mention} masuk sini 😒",
    "Ett dah ngapa lu {mention} masuk sini tod",
    "Hai {mention}, cakep lu kalo masuk sini mah",
    "Selamat datang {mention}, muka lu kek biji pler",
    "Halo kak {mention}, Aku cantik gak menurutmu?",
    "Selamat datang {mention} mau gk jadi pacarku?",
    "Halo {mention}, kenalin aku niskala, dibuat dengen sperma pilihan 😊",
    "Begitu suyit lupakan {mention}, apalagi {mention} kek pler 😘",
